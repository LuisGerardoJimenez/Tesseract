...
\begin{Citemize}
	...
	%\item \cdtIdRef{MSG18}{Modificación no permitida}: Se muestra en la pantalla \IUref{IU7}{Gestionar Pantalla} cuando la pantalla que se desea modificar se encuentra asociada a casos de uso liberados.
\end{Citemize}
