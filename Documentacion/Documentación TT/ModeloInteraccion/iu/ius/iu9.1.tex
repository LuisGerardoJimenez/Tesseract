...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \IUref{IU9.1}{Registrar Regla de Negocio} cuando se registre una regla de negocio con un nombre que ya se encuentre registrado.
