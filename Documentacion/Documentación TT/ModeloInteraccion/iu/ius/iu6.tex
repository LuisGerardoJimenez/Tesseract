...
\begin{itemize}
	...
	\item \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/tray}} [Gestionar Trayectorias]: Permite al actor solicitar la gestión de las trayectorias del caso de uso, dirige a la pantalla \IUref{IU6.1.1}{Gestionar trayectorias}.
	\item \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/talt}} [Gestionar Puntos de extensión]: Permite al actor solicitar la gestión de los puntos de extensión del caso de uso, dirige a la pantalla \IUref{IU6.1.4}{Gestionar puntos de extensión}.
	...
	\item \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/condiciones}} [Gestionar Pre/Postcondiciones]: Permite al actor solicitar la gestión de las precondiciones y postcondiciones del caso de uso, dirige a la pantalla \IUref{IU6.1.2}{Gestionar Pre/Postcondiciones}.
