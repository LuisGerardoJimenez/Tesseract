...
\subsubsection{Diseño}
	...
	Finalmente se mostrará el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU6}{Gestionar Casos de uso}, para indicar que la información del caso de uso se ha modificado correctamente.
