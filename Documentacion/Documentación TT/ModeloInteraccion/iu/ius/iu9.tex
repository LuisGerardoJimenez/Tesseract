...
\IUfig[1]{interfaces/IU9AgestionarBR}{IU9A}{Gestionar Reglas de Negocio: Sin registros}\label{IU9A}
\subsubsection{Comandos}
\begin{itemize}
	\item \IUbutton{Registrar}: Permite al actor solicitar el registro de una regla de negocio, dirige a la pantalla \IUref{IU9.1}{Registrar Regla de Negocio}
\end{itemize}
