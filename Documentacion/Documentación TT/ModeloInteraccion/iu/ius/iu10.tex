%--------------------------------------
\subsection{IU 10 Gestionar Mensajes}
...
\IUfig[1]{interfaces/IU10AgestionarMSG}{IU10A}{Gestionar Mensajes: Sin registros}\label{IU10A}
\subsubsection{Comandos}
\begin{itemize}
	\item \IUbutton{Registrar}: Permite al actor solicitar el registro de un mensaje, dirige a la pantalla \IUref{IU10.1}{Registrar Mensaje}
\end{itemize}