%--------------------------------------
\subsection{IU 4.2 Modificar Módulo}
...
\IUfig[1]{interfaces/IU4-2modificarModulo}{IU4.2}{Modificar Módulo}\label{IU4.2}
...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG5}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU4.2}{Modificar módulo} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
