...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG18}{Modificación no permitida}: Se muestra en la pantalla \IUref{IU9}{Gestionar Reglas de Negocio} cuando la regla de negocio que se desea modificar se encuentra asociado a casos de uso liberados.
\end{Citemize}
