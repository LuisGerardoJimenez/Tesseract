%--------------------------------------
\subsection{IU 7 Gestionar Pantallas}
...
\begin{itemize}
	...
	\item \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/acciones}}: Permite al actor solicitar la gestión de las acciones de la pantalla, dirige a la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones}.
\end{itemize}
...
\IUfig[1]{interfaces/IU7AgestionarPantallas}{IU7A}{Gestionar Pantallas: Sin registros}\label{IU7A}
\subsubsection{Comandos}
\begin{itemize}
	\item \IUbutton{Registrar}: Permite al actor solicitar el registro de una pantalla, dirige a la pantalla \IUref{IU7.1}{Registrar Pantalla}
\end{itemize}