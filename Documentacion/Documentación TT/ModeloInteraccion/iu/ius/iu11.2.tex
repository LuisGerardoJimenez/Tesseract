...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG18}{Modificación no permitida}: Se muestra en la pantalla \IUref{IU11}{Gestionar Términos de Glosario} cuando el término que se desea modificar se encuentra asociado a casos de uso liberados.
\end{Citemize}
