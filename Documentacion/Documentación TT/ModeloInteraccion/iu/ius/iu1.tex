...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG5}{Dato incorrecto}: Se muestra cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
	\item \cdtIdRef{MSG19}{Correo electrónico y/o contraseña incorrectos}: Se muestra cuando el correo electrónico y/o la contraseña ingresada son incorrectos.
\end{Citemize}
