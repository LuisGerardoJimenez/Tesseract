...
\subsubsection{Diseño}
	...
	Finalmente se mostrará el mensaje \cdtIdRef{MSG1}{Operación Exitosa} en la pantalla \IUref{IU6}{Gestionar Casos de uso}, para indicar que la información del caso de uso se ha registrado correctamente.
...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG5}{Formato incorrecto incorrecto}: Se muestra en la pantalla \IUref{IU6.1}{Registrar Caso de uso} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
