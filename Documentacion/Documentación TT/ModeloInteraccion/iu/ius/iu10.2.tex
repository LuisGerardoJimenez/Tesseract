...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG18}{Modificación no permitida}: Se muestra en la pantalla \IUref{IU10}{Gestionar Mensajes} cuando el mensaje que se desea modificar se encuentra asociado a casos de uso liberados.
\end{Citemize}
