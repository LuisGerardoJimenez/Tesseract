...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG5}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU4.1}{Registrar módulo} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
