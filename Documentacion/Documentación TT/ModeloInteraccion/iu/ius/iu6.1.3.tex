%--------------------------------------
\subsection{IU 6.1.3 Gestionar puntos de extensión}
...
\IUfig[1]{interfaces/IU6-1-4gestionarPuntosExt}{IU6.1.3}{Gestionar Puntos de Extensión}
...
\begin{itemize}
	...
	\item \IUbutton{Registrar}: Permite al actor solicitar el registro de un punto de extensión, dirige a la pantalla \IUref{IU6.1.3.1}{Registrar punto de extensión}
	\item \editar [Modificar]: Permite al actor solicitar la modificación de un punto de extensión, \IUref{IU6.1.3.2}{Modificar punto de extensión}
...
\IUfig[1]{interfaces/IU6-1-4AgestionarPEXT}{IU6.1.4A}{Gestionar Puntos de extensión: Sin registros}\label{IU6-1-3A}
\subsubsection{Comandos}
\begin{itemize}
	\item \IUbutton{Registrar}: Permite al actor solicitar el registro de un punto de extensión, dirige a la pantalla \IUref{IU6.1.3.1}{Registrar Punto de extensión}
\end{itemize}