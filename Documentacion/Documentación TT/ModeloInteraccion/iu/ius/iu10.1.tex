...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \IUref{IU10.1}{Registrar Mensaje} cuando se registre un mensaje con un nombre que ya se encuentre registrado.
\end{Citemize}
