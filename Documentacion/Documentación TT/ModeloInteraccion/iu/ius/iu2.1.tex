...
\begin{Citemize}
	...
	\item \cdtIdRef{MSG22}{No existe información}: Se muestra en la pantalla \IUref{IU2.1}{Registrar proyecto} cuando el actor ingrese fechas de término que no son posteriores a las fechas de inicio correspondientes.
\end{Citemize}
