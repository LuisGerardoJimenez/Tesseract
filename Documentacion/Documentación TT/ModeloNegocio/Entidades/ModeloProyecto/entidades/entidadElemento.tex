\begin{BusinessEntity}{elementoEntidad}{Elemento}
	...
	\Battr{numeroElemento}{Número: }{Número del Elemento. Es un valor numérico entero y este dato es \hyperlink{tRequerido}{requerido} {\em (no se puede omitir)}. Este atributo debe de contener como máximo 20 dígitos. Caracteres admitidos: [0-9]}
		
	\Battr{nombreElemento}{Nombre: }{Nombre que identificará al Elemento. Es una frase o enunciado y este dato es \hyperlink{tRequerido}{requerido} {\em (no se puede omitir)}. Este atributo debe de contener como mínimo 1 y máximo 200 caracteres. Caracteres admitidos: [A-Z] $|$ [a-z] $|$ [ñ-á-é-í-ó-ú] $|$ [Ñ-Á-É-Í-Ó-Ú] $|$ [0-9] $|$ [ ] $|$ [-] $|$ [$,$, .]}
\end{BusinessEntity}
