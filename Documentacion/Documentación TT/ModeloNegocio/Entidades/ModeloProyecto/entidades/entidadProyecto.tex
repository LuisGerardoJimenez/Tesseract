\begin{BusinessEntity}{proyectoEntidad}{Proyecto}
	...
	\Battr{contraparteProyecto}{Contraparte: }{Es el cliente del proyecto. Es una frase o enunciado y este dato es \hyperlink{tRequerido}{requerido} {\em (no se puede omitir)}.Este atributo debe de contener como mínimo 1 y máximo 45 caracteres. Caracteres admitidos: [A-Z] $|$ [a-z] $|$ [ñ-á-é-í-ó-ú] $|$ [Ñ-Á-É-Í-Ó-Ú] $|$ [0-9] $|$ [  ] $|$ [\_] $|$ [-] $|$ [$!$, $?$, \&, @, \%, \#, $($, $)$, ., :, >, <, *, =, $,$}
