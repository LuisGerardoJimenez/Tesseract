	...
	\UCitem{Salidas}{\begin{itemize}
			...
			\item \cdtRef{terminoGLSEntidad}{Término del glosario}: Tabla que muestra \cdtRef{terminoGLSEntidad:claveTGLS}{Clave}, y el \cdtRef{terminoGLSEntidad:nombreGLS}{Nombre} de todos los términos registrados de un proyecto.
	...
	\UCitem{Precondiciones}{
			\begin{itemize}
				...
				\item Que exista al menos un término de glosario registrado.
			\end{itemize}
			}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Gestiona los términos a través de los botones: \IUbutton{Registrar}, \editar, \eliminar y \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}}. 
\end{UCtrayectoria}		
%--------------------------------------
...
\UCExtenssionPoint{El actor requiere registrar un término.}{Presionando el botón \IUbutton{Registrar} del paso \ref{CU6-P4} de la trayectoria principal o del paso \ref{CU6-TA1} de la trayectoria alternativa A.}{\UCref{CU6.1}{Registrar Término}}
\UCExtenssionPoint{El actor requiere modificar un término.}{Presionando el icono \editar del paso \ref{CU6-P4} de la trayectoria principal.}{\UCref{CU6.2}{Modificar Término}}
\UCExtenssionPoint{El actor requiere eliminar un término.}{Presionando el icono \eliminar del paso \ref{CU6-P4} de la trayectoria principal.}{\UCref{CU6.3}{Eliminar Término}}
\UCExtenssionPoint{El actor requiere consultar un término.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} del paso \ref{CU6-P4} de la trayectoria principal.}{\UCref{CU6.4}{Consultar Término}}