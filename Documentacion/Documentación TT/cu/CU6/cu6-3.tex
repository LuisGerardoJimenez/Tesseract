	\begin{UseCase}{CU6.3}{Eliminar Término de Glosario}{
			Cuando algún \hyperlink{terminoGLSEntidad}{Término de glosario} está de más o simplemente no tiene una razón de ser dentro del \hyperlink{proyectoEntidad}{Proyecto}, Tesseract permitirá al colaborador (ya sea \hyperlink{jefe}{Líder} o \hyperlink{analista}{Analista}) eliminar en su totalidad su registro. \\
