...
\UCExtenssionPoint{El actor requiere gestionar los módulos de un proyecto.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/entrar}} \ref{CU4-P3} de la trayectoria principal o del paso \ref{CU4-TB1} de la trayectoria alternativa B.}{\UCref{CU5}{Gestionar Módulos}}
