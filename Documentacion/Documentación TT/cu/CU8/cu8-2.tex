	\begin{UseCase}{CU8.2}{Modificar Regla de negocio}{
		...
		\begin{itemize}
			...
			\item \cdtRef{BREntidad:descripcionBR}{Descripción de la Regla de Negocio:} Se escribe desde el teclado.
			...
			\item Para el tipo ''Formato correcto'':
				\begin{itemize}
					...
					\item \cdtRef{atributoEntidad}{Atributo que se verificará con la expresión regular}: Se selecciona de una lista.
		...
		\UCitem{Salidas}{\begin{itemize}
				...
				\begin{itemize}
					...
					\item \cdtRef{atributoEntidad}{Atributo 1}: Lo obtiene el sistema.
					\item Operador: Lo obtiene el sistema.
					\item \cdtRef{entidadEntidad}{Entidad 2}: Lo obtiene el sistema.
					\item \cdtRef{atributoEntidad}{Atributo 2}: Lo obtiene el sistema.
				\end{itemize}
				\item Para el tipo ''Unicidad de párametros'':
				\begin{itemize}
					\item \cdtRef{entidadEntidad}{Entidad}: Lo obtiene el sistema.
					\item \cdtRef{atributoEntidad}{Atributo único}: Lo obtiene el sistema.
				\end{itemize}
				\item Para el tipo ''Formato correcto'':
				\begin{itemize}
					\item \cdtRef{entidadEntidad}{Entidad que contiene el atributo para verificar el formato}: Lo obtiene el sistema.
					\item \cdtRef{atributoEntidad}{Atributo que se verificará con la expresión regular}: Lo obtiene el sistema.
		...
		\UCitem{Precondiciones}{\begin{itemize}
				...
				\item Que el catálogo ''tipo de regla de negocio'' contenga información.
				\item Que los catálogos de entidades y atributos contengan información.
			\end{itemize}
		}
		...
		\item \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \IUref{IU9.2}{Modificar Regla de negocio} cuando se registre un regla de negocio con un nombre que ya se encuentre registrado en el sistema.
		\item \cdtIdRef{MSG29}{Los catálogos nos contienen información}: Se muestra en la pantalla \IUref{IU9}{Gestionar Reglas de negocio} cuando no exista información en el catálogo ''tipo de regla de negocio''.
		\end{itemize}
		}
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Los catálogos nos contienen información} en la pantalla \IUref{IU9}{Gestionar Reglas de negocio} para indicar que no es posible realizar la operación debido a la falta de información necesaria para el sistema.
