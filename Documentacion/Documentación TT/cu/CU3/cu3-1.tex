	\begin{UseCase}{CU3.1}{Registrar persona}{
		Permite al {\hyperlink{admin}{Administrador}} registrar la información de una persona en el sistema, dicho integrante podrá ser elegido como colaborador de un proyecto (ya sea como {\hyperlink{jefe}{lider de proyecto}} o {\hyperlink{analista}{analista}}).\\
