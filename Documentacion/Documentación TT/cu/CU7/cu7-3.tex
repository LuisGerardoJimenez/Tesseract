	\begin{UseCase}{CU7.3}{Eliminar Entidad}{
		...
		\UCitem{Errores}{
		\cdtIdRef{MSG13}{Eliminación no permitida}: Se muestra en la pantalla \IUref{IU12}{Gestionar Entidades} cuando la entidad del glosario no se encuentre en un estado que permita la eliminación.
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}. \hyperlink{CU7-3:TAA}{[Trayectoria A]}
