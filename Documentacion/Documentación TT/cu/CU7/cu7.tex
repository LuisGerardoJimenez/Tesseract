...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Gestiona las entidades a través de los botones: \IUbutton{Registrar}, \editar , \eliminar, \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} y (Atributo). 
\end{UCtrayectoria}		
%--------------------------------------
