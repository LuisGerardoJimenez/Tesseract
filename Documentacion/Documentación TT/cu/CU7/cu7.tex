...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Gestiona las entidades a través de los botones: \IUbutton{Registrar}, \editar , \eliminar, \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} y \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/Atributo}}. 
\end{UCtrayectoria}		
%--------------------------------------
...
\UCExtenssionPoint{El actor requiere gestionar los atributos de la entidad.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/Atributo}} del paso \ref{CU7-P4} de la trayectoria principal.}{\UCref{CU7.1.1}{Gestionar Atributos}}