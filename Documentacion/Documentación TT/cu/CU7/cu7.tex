...
\UCExtenssionPoint{El actor requiere gestionar los atributos de la entidad.}{Presionando el icono (Pendiente) del paso \ref{CU7-P4} de la trayectoria principal.}{\UCref{CU7.1.1}{Gestionar Atributos}}