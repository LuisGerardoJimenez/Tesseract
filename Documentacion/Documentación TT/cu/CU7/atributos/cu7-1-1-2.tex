	\begin{UseCase}{CU7.1.1.2}{Modificar Atributo}{
		...
		\UCitem{Salidas}{\begin{itemize}
			...
			\item \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \IUref{IU12.1.1.1}{Gestionar Atributos} para indicar que el registro fue exitoso.
		\end{itemize}
		}
		...
		\item \cdtIdRef{MSG29}{No existe información necesaria en el sistema}: Se muestra en la pantalla \IUref{IU12.1.1.1}{Gestionar Atributos} cuando no exista información en el catálogo ''tipo de dato'' o ''unidad de tamaño''.
		\end{itemize}
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU12.1.1.1}{Gestionar Atributos} para indicar al actor que el registro se ha realizado exitosamente.
	\end{UCtrayectoria}		
%--------------------------------------
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{No existe información necesaria en el sistema} en la pantalla \IUref{IU12.1.1.1}{Gestionar Atributos} para indicar que no es posible realizar la operación debido a la falta de información necesaria para el sistema.
