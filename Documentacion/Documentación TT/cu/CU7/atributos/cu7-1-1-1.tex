...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que el catálogo ''tipo de dato'' y ''unidad de tamaño'' cuenten con información, con base en la regla de negocio \BRref{RN20}{Verificación de catálogos}. \hyperlink{CU7-1-1:TAA}{[Trayectoria A]}
