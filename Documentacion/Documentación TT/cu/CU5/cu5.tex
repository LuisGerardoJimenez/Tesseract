...
\UCExtenssionPoint{El actor requiere gestionar el glosario de un proyectos.}{Eligiendo la opción ''Glosario'' del menu \IUref{MN3}{Menú de Proyecto} del paso \ref{CU4-P3} de la trayectoria principal o del paso \ref{CU5-TA1} de la trayectoria alternativa B.}{\UCref{CU6}{Gestionar Términos}}
\UCExtenssionPoint{El actor requiere gestionar las entidades de un proyecto.}{Eligiendo la opción ''Entidades'' del menu \IUref{MN3}{Menú de Proyecto} del paso \ref{CU5-P3} de la trayectoria principal o del paso \ref{CU5-TA1} de la trayectoria alternativa B.}{\UCref{CU7}{Gestionar Entidades}}
\UCExtenssionPoint{El actor requiere gestionar las reglas de negocio de un proyecto.}{Eligiendo la opción ''Reglas de negocio'' del menu \IUref{MN3}{Menú de Proyecto} del paso \ref{CU5-P3} de la trayectoria principal o del paso \ref{CU5-TA1} de la trayectoria alternativa B.}{\UCref{CU8}{Gestionar reglas de negocio}}
\UCExtenssionPoint{El actor requiere gestionar los mensajes de un proyecto.}{Eligiendo la opción ''Mensajes'' del menu \IUref{MN3}{Menú de Proyecto} del paso \ref{CU5-P3} de la trayectoria principal o del paso \ref{CU5-TA1} de la trayectoria alternativa B.}{\UCref{CU9}{Gestionar Mensajes}}
\UCExtenssionPoint{El actor requiere gestionar los actores de un proyecto.}{Eligiendo la opción ''Actores'' del menu \IUref{MN3}{Menú de Proyecto} del paso \ref{CU5-P3} de la trayectoria principal o del paso \ref{CU5-TA1} de la trayectoria alternativa B}{\UCref{CU10}{Gestionar Actores}}