...
\begin{UCtrayectoriaA}{GIU-A}{No existen registros de pantallas.}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{No existe información} en la pantalla \IUref{IU7}{Gestionar Pantallas} para indicar que no hay registros de pantallas para mostrar.
\end{UCtrayectoriaA}
