...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Gestiona los proyectos a través de los botones: \IUbutton{Registrar}, \editar, \eliminar, \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} y (Acciones). 
\end{UCtrayectoria}		
%--------------------------------------
...
\UCExtenssionPoint{El actor requiere gestionar las acciones de una pantalla}{Presionando el icono (Atributos) del paso \ref{CU11-P4} de la trayectoria principal.}{\UCref{CU11.1.1}{Gestionar Acciones}}