	\begin{UseCase}{CU11.2}{Modificar Pantalla}{
		...
		\UCitem{Entradas}{
		\begin{itemize}
			\item \cdtRef{EntidadPantalla:numeroIU}{Número de la pantalla}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:nombreIU}{Nombre de la pantalla}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:descripcionIU}{Descripción de la pantalla}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:imagenIU}{Imagen de la pantalla}: Se selecciona de los archivos locales.
		\end{itemize}	
		}
		\UCitem{Salidas}{\begin{itemize}
				...
				\item \cdtRef{EntidadPantalla:numeroIU}{Número de la pantalla}: Lo obtiene el sistema.
				\item \cdtRef{EntidadPantalla:nombreIU}{Nombre de la pantalla}: Lo obtiene el sistema.
				\item \cdtRef{EntidadPantalla:descripcionIU}{Descripción de la pantalla}: Lo obtiene el sistema.
				\item \cdtRef{EntidadPantalla:imagenIU}{Imagen de la pantalla}: Lo obtiene el sistema.
				\item \cdtRef{EntidadPantalla:claveIU}{Clave:} Lo calcula el sistema mediante la regla de negocio \BRref{RN12}{Identifcador de elemento}.
