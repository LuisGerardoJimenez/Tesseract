	\begin{UseCase}{CU11.1}{Registrar Pantalla}{
		...
		\UCitem{Entradas}{
		\begin{itemize}
			\item \cdtRef{EntidadPantalla:numeroIU}{Número}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:nombreIU}{Nombre}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:descripcionIU}{Descripción}: Se escribe desde el teclado.
			\item \cdtRef{EntidadPantalla:imagenIU}{Imagen}: Se selecciona de los archivos locales.
		\end{itemize}	
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}.\hyperlink{CU11-1:TAA}{[Trayectoria A]}
