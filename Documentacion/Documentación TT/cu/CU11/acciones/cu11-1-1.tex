	\begin{UseCase}{CU11.1.1}{Gestionar Acciones}{
		...
		El colaborador (\hyperlink{jefe}{Líder de Análisis} o \hyperlink{analista}{Analista}) podrá gestionar las \hyperlink{EntidadAccion}{acciones} propias de cada \cdtRef{EntidadPantalla}{Pantalla}.\\
	...
	\UCitem{Salidas}{\begin{itemize}
			...
			\item \cdtRef{EntidadAccion}{Acción}: Tabla que muestra el \cdtRef{EntidadAccion:nombreACC}{Nombre} y la \cdtRef{EntidadAccion:imagenACC}{Imagen} de todas las acciones registradas en un pantalla.
...
%--------------------------------------
\begin{UCtrayectoria}
	\UCpaso[\UCactor] Solicita gestionar las acciones de una pantalla seleccionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/acciones}} de la pantalla \IUref{IU7}{Gestionar Pantallas}.
