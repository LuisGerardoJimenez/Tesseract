	\begin{UseCase}{CU11.1.1.3}{Eliminar Acción}{
		...
		\UCitem{Salidas}{\begin{itemize}
				\item \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} para indicar que la acción fue eliminada correctamente.
				\item \cdtIdRef{MSG10}{Confirmar eliminación}: Se muestra en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} preguntando al actor si desea continuar con la eliminación de la acción.
		\end{itemize}}
		...
		\item \cdtIdRef{MSG13}{Eliminación no permitida}: Se muestra en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} cuando no se pueda eleiminar la acción debido a que está siendo referenciada en algún caso de uso.
		\end{itemize}
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Da clic en el icono \eliminar del registro que desea eliminar de la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones}.
		\UCpaso[\UCsist] Muestra el mensaje emergente \cdtIdRef{MSG10}{Confirmar eliminación} con los botones \IUbutton{Aceptar} y \IUbutton{Cancelar} en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones}.
		...
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} para indicar al actor que el registro se ha eliminado exitosamente.
	\end{UCtrayectoria}		
%--------------------------------------
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} con el mensaje \cdtIdRef{MSG13}{Eliminación no permitida}.
	\item[- -] - - {\em {Fin del caso de uso}}.%
\end{enumerate}
