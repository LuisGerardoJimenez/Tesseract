	...
	\UCitem{Errores}{\begin{itemize}
			...
			\item \cdtIdRef{MSG29}{No existe información necesaria en el sistema}: Se muestra en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} cuando no exista información en el catálogo ''Tipo de acción''.
		\end{itemize}.
	}
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{No existe información necesaria en el sistema} en la pantalla \IUref{IU7.1.1.1}{Gestionar Acciones} para indicar que no es posible realizar la operación debido a la falta de información necesaria para el sistema.
