	\begin{UseCase}{CU10.1}{Registrar Actor}{
		...
		\item \cdtIdRef{MSG29}{No existe información necesaria en el sistema}: Se muestra en la pantalla \IUref{IU8}{Gestionar Actores} cuando no exista información en el catálogo ''cardinalidad''.
		\end{itemize}.
		}
...
\begin{enumerate}
	\UCpaso[\UCactor] Muestra el mensaje \cdtIdRef{MSG29}{No existe información necesaria en el sistema} en la pantalla \IUref{IU8}{Gestionar Actores}.
