	\begin{UseCase}{CU10.1}{Registrar Actor}{
		...
		\begin{itemize}
			...
			\item \cdtRef{actorEntidad:oCardinalidadACC}{Cardinalidad del actor:} Se selecciona de una lista.
		\end{itemize}	
		}
		...
		\item \cdtIdRef{MSG29}{Los catálogos nos contienen información}: Se muestra en la pantalla \IUref{IU8}{Gestionar Actores} cuando no exista información en el catálogo ''cardinalidad''.
		\end{itemize}.
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Solicita registrar un actor oprimiendo el botón \IUbutton{Registrar} de la pantalla \IUref{IU8}{Gestionar Actores}.
		\UCpaso[\UCsist] Verifica que exista información referente a la Cardinalidad con base en la regla de negocio \BRref{RN20}{Verificación de catálogos}. \hyperlink{CU10-1:TAA}{[Trayectoria A]}
		...
		\UCpaso[\UCsist] Persiste la información del actor en el sistema.
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Los catálogos nos contienen información} en la pantalla \IUref{IU8}{Gestionar Actores}.
