...
Cuando se ha registrado un nuevo \hyperlink{proyectoEntidad}{Proyecto} y se requiere modificar su información, el sistema monstrará al {\hyperlink{admin}{Administrador}} un formulario mediante el cual podrá actualizar cualquiera de los datos previamente registrados.\\
...
Una vez registrado el \hyperlink{proyectoEntidad}{Proyecto}, es posible que además del \cdtRef{proyectoEntidad:estadoProyecto}{estado}: Iniciado y Negociación también sea posible asignar el estado: Terminado
	}
		...
		\item \cdtIdRef{MSG26}{Orden de fechas}: Se muestra en la pantalla \IUref{IU2.2}{Modificar proyecto} cuando el actor ingrese fechas de término que no son posteriores a las fechas
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Solicita guardar el proyecto oprimiendo el botón \IUbutton{Aceptar}. \hyperlink{CU2-2:TAC}{[Trayectoria C]}
...
%--------------------------------------
	...
	\begin{enumerate}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Formato incorrecto} señalando el campo que presenta el error en la pantalla \IUref{IU2.2}{Modificar Proyecto}.
		\UCpaso Regresa al paso \ref{CU2.1-P5} de la trayectoria principal.
		\item[- -] - - {\em {Fin de la trayectoria}}.
	\end{enumerate}
	%--------------------------------------
	...
	\begin{enumerate}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG26}{Orden de fechas} en el campo de fecha de término programada en la pantalla \IUref{IU2.2}{Modificar Proyecto}.
		\UCpaso Regresa al paso \ref{CU2.1-P5} de la trayectoria principal.
		\item[- -] - - {\em {Fin de la trayectoria}}.
	\end{enumerate}