	\begin{UseCase}{CU2.2}{Modificar proyecto de Administrador}{
		...
		\item \cdtIdRef{MSG12}{Ha ocurrido un error}: Se muestra en la pantalla \IUref{IU2}{Gestionar proyectos de Administrador} cuando no exista información en el catálogo ''estados de un proeycto''.
