	\begin{UseCase}{CU2.1}{Registrar proyecto}{
				Permite al {\hyperlink{admin}{Administrador}} registrar la información general de un proyecto en el sistema, dichos datos se guardan con el fin de conocer las propiedades referentes a cada proyecto, como caracteristicas, tiempos estimados, presupuestos, etc.
	}
