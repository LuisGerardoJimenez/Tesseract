	\begin{UseCase}{CU2.1}{Registrar proyecto de Administrador}{
				Permite al {\hyperlink{admin}{Administrador}} registrar la información general de un proyecto en el sistema, dichos datos se guardan con el objetivo de conocer las propiedades referentes a cada proyecto, como lo son sus caracteristicas, tiempos estimados, presupuestos, etc.
		...
		\begin{itemize}
			...
			\item Interna: Que exista información dentro del catálogo "estados un proyecto".
		\end{itemize}
		}
