	\begin{UseCase}{CU13}{Descargar documento}{
				...
				Desde la gestión de proyectos se le permitirá al colaborador (\hyperlink{jefe}{Líder de Análisis} o \hyperlink{analista}{Analista} descargar el documento de análisis. Este instrumento contiene cada uno de los elementos que se gestionan al interior de los módulos de cada proyecto como el glosario de términos, descripción de las entidades, reglas de negocio, mensajes, actores, casos de uso (con sus trayectorias, precondiciones, postcondiciones y puntos de extensión) y pantallas, así como la información propia del proyecto.
