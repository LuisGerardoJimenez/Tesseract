	\begin{UseCase}{CU1}{Iniciar sesión}{
		...
		\item \cdtIdRef{MSG5}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU1}{Iniciar Sesión} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
		\item \cdtIdRef{MSG19}{Correo electrónico y/o contraseña incorrectos}: Se muestra en la pantalla \IUref{IU1}{Iniciar Sesión} cuando el correo electrónico y/o la contraseña ingresada son incorrectos.
		\end{itemize}
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Inicia sesión como administrador. \hyperlink{CU1:TAF}{[Trayectoria F]}
...
%--------------------------------------
		...
		\begin{enumerate}
			\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG4}{Dato Obligatorio} señalando el campo que presenta el error en la pantalla \IUref{IU1}{Iniciar Sesión}.
...
%--------------------------------------
	...
	\begin{enumerate}
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG5}{Formato incorrecto} señalando el campo que presenta el error en la pantalla \IUref{IU1}{Iniciar sesión}.
...
%--------------------------------------
		...
		\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG19}{Correo electrónico y/o contraseña incorrectos} en la pantalla \IUref{IU1}{Iniciar Sesión} notificando que los datos ingresados son incorrectos.
	\UCpaso[\UCactor] Regresa al paso \ref{P3} de la Trayectoria Principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}
...
\noindent \textbf{Condición:} El actor inicio sesión como colaborador.
\begin{enumerate}
