	\begin{UseCase}{CU12.1.4.3}{Eliminar Punto de extensión}{
		...
		\UCitem{Salidas}{\begin{itemize}
				...
				\item \cdtIdRef{MSG10}{Confirmar eliminación}: Se muestra en la pantalla \IUref{IU6.1.1}{Gestionar Puntos de extensión} preguntando al actor si desea continua con la eliminación del punto de extensión.
		\end{itemize}}
...
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Da clic en el icono \eliminar del registro que desea eliminar de la pantalla \IUref{IU6.1.4}{Gestionar Puntos de extensión}.
		\UCpaso[\UCactor] Verifica que el caso de uso se encuentre en estado ''Edición'' o en estado ''Pendiente de corrección''. \hyperlink{CU12-1-6-3:TAA}{[Trayectoria A]}
		...
		\UCpaso[\UCactor] Confirma la eliminación de la pantalla oprimiendo el botón \IUbutton{Aceptar}. \hyperlink{CU12-1-6-3:TAB}{[Trayectoria B]}
