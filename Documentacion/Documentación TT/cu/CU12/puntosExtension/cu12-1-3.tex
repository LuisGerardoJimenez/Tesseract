	...
	\UCitem{Salidas}{\begin{itemize}
			...
			\item \cdtRef{entidadExtension}{Punto de extensión}: Tabla que muestra la \cdtRef{entidadExtension:causaPE}{causa}, la \cdtRef{entidadExtension:regionPE}{región de la trayectoria} y el \cdtRef{entidadExtension:ExtiendePE}{caso de uso que extiende} de todos los registros.
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG2}{No existe información} en la pantalla \IUref{IU6.1.4A}{Gestionar Puntos de extensión: Sin registros} para indicar que no hay registros de puntos de extensión para mostrar. \label{CU12.1.6-TA1}
