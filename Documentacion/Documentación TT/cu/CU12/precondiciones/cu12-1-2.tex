	\begin{UseCase}{CU12.1.2}{Registrar Precondición}{
		...
		\item \cdtIdRef{MSG29}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU6.1.2}{Registrar Precondición} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}. \hyperlink{CU12-1-2:TAB}{[Trayectoria B]} 
		\UCpaso[\UCsist] Verifica que el actor ingrese todos los campos obligatorios con base en la regla de negocio \BRref{RN8}{Datos obligatorios}. \hyperlink{CU12-1-2:TAC}{[Trayectoria C]}
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \hyperlink{CU12-1-2:TAD}{[Trayectoria D]}
		\UCpaso[\UCsist] Verifica que los datos ingresados cumplan con el formato requerido, con base en la regla de negocio \BRref{RN7}{Información correcta}. \hyperlink{CU12-1-2:TAE}{[Trayectoria E]}
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-2:TAB}{\textbf{Trayectoria alternativa B}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-2:TAC}{\textbf{Trayectoria alternativa C}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-2:TAD}{\textbf{Trayectoria alternativa D}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-2:TAE}{\textbf{Trayectoria alternativa E}}\\
\noindent \textbf{Condición:} El actor ingresó un dato con un formato incorrecto.
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Formato incorrecto} señalando el campo que presenta el error en la pantalla \IUref{IU6.1.2}{Registrar Precondición}.
	\UCpaso Regresa al paso \ref{CU12.1.2-P3} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-2:TAH}{\textbf{Trayectoria alternativa F}}\\
