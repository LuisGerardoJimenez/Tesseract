	\begin{UseCase}{CU12.1.3.1}{Registrar Postcondición}{
...
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Solicita registrar una postcondición oprimiendo el botón \IUbutton{Registrar} de la pantalla \IUref{IU6.1}{Pendiente}.
		\UCpaso[\UCsist] Muestra la pantalla \IUref{IU6.1.3}{Registrar Postcondición}.
		\UCpaso[\UCactor] Ingresa la redacción de la postcondición. \hyperlink{CU12-1-3-1:TAA}{[Trayectoria A]} \label{CU12.1.3.1-P3}
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}. \hyperlink{CU12-1-3-1:TAB}{[Trayectoria B]} 
		\UCpaso[\UCsist] Verifica que el actor ingrese todos los campos obligatorios con base en la regla de negocio \BRref{RN8}{Datos obligatorios}. \hyperlink{CU12-1-3-1:TAC}{[Trayectoria C]}
		\UCpaso[\UCsist] Verifica que los datos requeridos sean proporcionados correctamente con base en la regla de negocio \BRref{RN7}{Información correcta}. \hyperlink{CU12-1-3-1:TAD}{[Trayectoria D]}
		\UCpaso[\UCsist] Verifica que los datos ingresados cumplan con el formato requerido, con base en la regla de negocio \BRref{RN7}{Información correcta}. \hyperlink{CU12-1-3-1:TAE}{[Trayectoria E]}
		\UCpaso[\UCsist] Persiste la información de la postcondición en el sistema.
	...
	\end{UCtrayectoria}		
%-------------------------------------
\hypertarget{CU12-1-3-1:TAA}{\textbf{Trayectoria alternativa A}}\\
...
\begin{enumerate}
	...
	\UCpaso[\UCsist] Verifica que el nombre del elemento seleccionado no contenga espacios. \hyperlink{CU12-1-3-1:TAF}{[Trayectoria F]}
	\UCpaso[\UCsist] Agrega la referencia del elemento al texto. \label{CU12.1.3.1-TA1}
	\UCpaso Continúa en el paso \ref{CU12.1.3.1-P3} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.%
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-3-1:TAB}{\textbf{Trayectoria alternativa B}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-3-1:TAC}{\textbf{Trayectoria alternativa C}}\\
...
\begin{enumerate}
	...
	\UCpaso Regresa al paso \ref{CU12.1.3.1-P3} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.%
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-3-1:TAD}{\textbf{Trayectoria alternativa D}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-3-1:TAE}{\textbf{Trayectoria alternativa E}}\\
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-3-1:TAH}{\textbf{Trayectoria alternativa F}}\\
\noindent \textbf{Condición:} El texto contiene espacios.
\begin{enumerate}
	\UCpaso[\UCsist] Sustituye los espacios por guiones bajos.
	\UCpaso Continua en el \ref{CU12.1.3.1-TA1} de la trayectoria alternativa A.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}