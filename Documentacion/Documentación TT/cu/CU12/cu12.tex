...
\UCExtenssionPoint{El actor requiere gestionar las precondiciones/postcondiciones.}{Presionando el icono (Pendiente) del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.1.2}{Gestionar Precondiciones/Postcondiciones}}