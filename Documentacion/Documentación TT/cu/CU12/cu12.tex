	...
	\end{itemize}}
	\UCitem{Precondiciones}{Que existe al menos un módulo registrado.}
...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Muestra la información de los casos de uso en la pantalla \IUref{IU6}{Gestionar Casos de uso} y las operaciones disponibles de acuerdo a la regla de negocio \BRref{RN9}{Operaciones disponibles de casos de uso}.\label{CU12-P4}
...
\UCExtenssionPoint{El actor requiere gestionar los puntos de extensión de un caso de uso.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/talt}} del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.1.3}{Gestionar Puntos de extensión}}
...
\UCExtenssionPoint{El actor requiere consultar un Caso de uso.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}} del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.4}{Consultar Caso de uso}}
\UCExtenssionPoint{El actor requiere terminar un caso de uso.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/terminar}} del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.5}{Teminar Caso de uso}}
\UCExtenssionPoint{El actor requiere revisar un caso de uso.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/revisar}} del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.6}{Revisar Caso de uso}}
\UCExtenssionPoint{El actor requiere gestionar las Pre/postcondiciones.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/condiciones}} del paso \ref{CU12-P4} de la trayectoria principal.}{\UCref{CU12.1.2}{Gestionar Pre/Postcondiciones}}