	\begin{UseCase}{CU12.1.1.1.1.1}{Registrar Paso}{
		...
		\item \cdtIdRef{MSG29}{Los catálogos nos contienen información}: Se muestra en la pantalla \IUref{IU6.1.1.1}{Pendiente} cuando no exista información en los catálogos  ''Realiza'' y ''Verbo''.
		\end{itemize}}
		\UCitem{Tipo}{Secundario, extiende del caso de uso \UCref{CU12.1.1.1.1}{Gestionar Pasos}.}
	\end{UseCase}
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Solicita registrar un paso oprimiendo el botón \IUbutton{Registrar} de la pantalla \IUref{IU6.1.1.1}{Pendiente}.
		...
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU6.1.1}{Pendiente} para indicar al actor que el registro se ha realizado exitosamente.
	\end{UCtrayectoria}		
%--------------------------------------
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Los catálogos nos contienen información} en la pantalla \IUref{IU6.1.1.1}{Pendiente} para indicar que no es posible realizar la operación debido a la falta de información necesaria para el sistema.
