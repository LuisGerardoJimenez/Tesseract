	\begin{UseCase}{CU12.1.1.1.1.1}{Registrar Paso}{
		...
		\item \cdtIdRef{MSG12}{Ha ocurrido un error}: Se muestra en la pantalla \IUref{IU6.1.1.1}{Pendiente} cuando no exista información en los catálogos  ''Realiza'' y ''Verbo''.
		\end{itemize}}
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG12}{Ha ocurrido un error} en la pantalla \IUref{IU6.1.1.1}{Pendiente} para indicar que no es posible realizar la operación debido a la falta de información necesaria para el sistema.
