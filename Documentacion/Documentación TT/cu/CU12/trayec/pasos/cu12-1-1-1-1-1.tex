	\begin{UseCase}{CU12.1.1.1.1.1}{Registrar Paso}{
		...
		\UCitem{Salidas}{\begin{itemize}
				...
				\item \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} para indicar que el registro fue exitoso.
		\end{itemize}}
		...
		\UCitem{Postcondiciones}{\begin{itemize}
				\item Se registrará un paso perteneciente a una trayectoria.
				\item El paso podrá ser referenciado en otros paso y/o casos de uso.
		\end{itemize}}
		...
		\item \cdtIdRef{MSG5}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU6.1.1.1.1}{Registrar Paso} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
...
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Solicita registrar un paso oprimiendo el botón \IUbutton{Registrar} de la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos}.
		\UCpaso[\UCsist] Verifica que los catálogos ''Realiza'' y ''Verbo'' cuente con información, con base en la regla de negocio \BRref{RN20}{Verificación de catálogos}. \hyperlink{CU12-1-1-1-1-1:TAA}{[Trayectoria A]}
		...
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}. \label{CU12.1.1.1.1.1-P6} \hyperlink{CU12-1-1-1-1-1:TAC}{[Trayectoria C]} 
		\UCpaso[\UCsist] Verifica que el actor ingrese todos los campos obligatorios con base en la regla de negocio \BRref{RN8}{Datos obligatorios}. \hyperlink{CU12-1-1-1-1-1:TAD}{[Trayectoria D]}
		\UCpaso[\UCsist] Verifica que los datos ingresados cumpla con la longitud correcta, con base en la regla de negocio \BRref{RN37}{Longitud de datos}. \hyperlink{CU12-1-1-1-1-1:TAE}{[Trayectoria E]}
		\UCpaso[\UCsist] Verifica que los datos ingresados cumplan con el formato requerido, con base en la regla de negocio \BRref{RN7}{Información correcta}. \hyperlink{CU12-1-1-1-1-1:TAF}{[Trayectoria F]}
		\UCpaso[\UCsist] Persiste la información del paso.
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} para indicar al actor que el registro se ha realizado exitosamente.
	\end{UCtrayectoria}		
%--------------------------------------
...
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-1-1-1-1:TAB}{\textbf{Trayectoria alternativa B}}\\
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG4}{Dato obligatorio} señalando el campo que presenta el error en la pantalla \IUref{IU6.1.1.1.1}{Registrar Paso}.
	\UCpaso Regresa al paso \ref{CU12.1.1.1.1.1-P5} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.%
\end{enumerate}
%--------------------------------------
\hypertarget{CU12-1-1-1-1-1:TAE}{\textbf{Trayectoria alternativa E}}\\
\noindent \textbf{Condición:} El actor ingresó un dato con un número de caracteres fuera del rango permitido.
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG6}{Longitud inválida} señalando el campo que presenta el error en la pantalla \IUref{IU6.1.1.1.1}{Registrar Paso}.
	\UCpaso Regresa al paso \ref{CU12.1.1.1.1.1-P5} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.%
\end{enumerate}
%--------------------------------------
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG5}{Formato incorrecto} señalando el campo que presenta el error en la pantalla \IUref{IU6.1.1.1.1}{Registrar Paso}.
	\UCpaso Regresa al paso \ref{CU12.1.1.1.1.1-P5} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}
%--------------------------------------
...
\begin{enumerate}
	...
	\UCpaso Continua en el \ref{CU12.1.1.1.1.1-TA1} de la trayectoria alternativa B.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}