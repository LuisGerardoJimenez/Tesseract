	\begin{UseCase}{CU12.1.1.1.1.3}{Eliminar Paso}{
		...
		\UCitem{Salidas}{
				\begin{itemize}
					\item \cdtIdRef{MSG10}{Confirmar eliminación}: Se muestra en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} preguntando al actor si desea continuar con la eliminación del paso.
					\item \cdtIdRef{MSG1}{Operación exitosa}: Se muestra en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} para indicar que el paso fue eliminado correctamente.
				\end{itemize}
		}
		...
		\UCitem{Errores}{
		\cdtIdRef{MSG13}{Eliminación no permitida}: Se muestra en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} cuando no se pueda eliminar el paso debido a que está siendo utilizado por otro elemento.
		}
		\UCitem{Tipo}{Secundario, extiende del caso de uso \UCref{CU12.1.1.1.1}{Gestionar Pasos}.}
	\end{UseCase}
%--------------------------------------
	\begin{UCtrayectoria}
		\UCpaso[\UCactor] Da clic en el icono \eliminar del registro que desea eliminar de la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos}.
		...
		\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG1}{Operación exitosa} en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos} para indicar al actor que el registro se ha eliminado exitosamente.
	\end{UCtrayectoria}		
%--------------------------------------
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG13}{Eliminación no permitida} en la pantalla \IUref{IU6.1.1.1.1.1}{Gestionar Pasos}.
	\item[- -] - - {\em {Fin del caso de uso}}.
\end{enumerate}
