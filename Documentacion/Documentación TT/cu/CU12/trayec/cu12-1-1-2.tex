	\begin{UseCase}{CU12.1.1.2}{Modificar Trayectoria}{
		...
		\item \cdtIdRef{MSG29}{Formato incorrecto}: Se muestra en la pantalla \IUref{IU6.1.1.2}{Modificar Trayectoria} cuando el tipo de dato ingresado no cumple con el tipo de dato solicitado en el campo.
		...
		\item \cdtIdRef{MSG16}{Registro necesario}: Se muestra en la pantalla \IUref{IU6.1.1.2}{Modificar Trayectoria} cuando el actor no registro ningún paso de la trayectoria.
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCactor] Gestiona los pasos de la trayectoria a través de los botones: \IUbutton{Registrar}, \editar y \eliminar. \label{CU12.1.1.2-P18}
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Aceptar}. \hyperlink{CU12-1-1-2:TAC}{[Trayectoria C]} 
...
\begin{enumerate}
	\UCpaso[\UCsist] Muestra el mensaje \cdtIdRef{MSG29}{Formato incorrecto} señalando el campo que presenta el error en la pantalla \IUref{IU6.1.1.2}{Modificar Trayectoria}.
	\UCpaso Regresa al paso \ref{CU12.1.1.2-P15} de la trayectoria principal.
	\item[- -] - - {\em {Fin de la trayectoria}}.
\end{enumerate}
%--------------------------------------	
...
\UCExtenssionPoint{El actor requiere registrar un paso de la trayectoria.}{Paso \ref{CU12.1.1.2-P14} de la trayectoria principal.}{\UCref{CU12.1.1.1.1}{Registrar Paso}}
\UCExtenssionPoint{El actor requiere modificar un paso de la trayectoria.}{Paso \ref{CU12.1.1.2-P14} de la trayectoria principal.}{\UCref{CU12.1.1.1.2}{Modificar Paso}}
\UCExtenssionPoint{El actor requiere eliminar un paso de la trayectoria.}{Paso \ref{CU12.1.1.2-P14} de la trayectoria principal.}{\UCref{CU12.1.1.1.3}{Eliminar Paso}}