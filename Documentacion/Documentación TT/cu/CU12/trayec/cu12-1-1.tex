...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCactor] Gestiona las trayectorias a través de los botones: \IUbutton{Registrar}, \editar, \eliminar y \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/pasos}}. \label{CU12.1.1-P5}
\end{UCtrayectoria}		
%--------------------------------------
...
\UCExtenssionPoint{El actor requiere registrar una trayectoria.}{Presionando el botón \IUbutton{Registrar} del paso \ref{CU12.1.1-P5} de la trayectoria principal o del paso \ref{CU12-1-1-TA1} de la Trayectoria alternativa A.}{\UCref{CU12.1.1.1}{Registrar Trayectoria}}
\UCExtenssionPoint{El actor requiere modificar una trayectoria.}{Presionando el icono \editar del paso \ref{CU12.1.1-P5} de la trayectoria principal.}{\UCref{CU12.1.1.2}{Modificar Trayectoria}}
\UCExtenssionPoint{El actor requiere eliminar una trayectoria.}{Presionando el icono \eliminar del paso \ref{CU12.1.1-P5} de la trayectoria principal.}{\UCref{CU12.1.1.3}{Eliminar Trayectoria}}
\UCExtenssionPoint{El actor requiere gestionar los pasos de la trayectoria.}{Presionando el icono \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/pasos}} del paso \ref{CU12.1.1-P5} de la trayectoria principal.}{\UCref{CU12.1.1.1.1}{Gestionar Pasos}}
