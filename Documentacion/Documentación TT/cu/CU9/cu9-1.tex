	\begin{UseCase}{CU9.1}{Registrar Mensaje}{
		...
		\item \cdtIdRef{MSG7}{Registro repetido}: Se muestra en la pantalla \IUref{IU10.1}{Registrar Mensaje} cuando se registre un mensaje con un nombre que ya se encuentre registrado en el sistema.
		\end{itemize}.
		}
...
%--------------------------------------
	\begin{UCtrayectoria}
		...
		\UCpaso[\UCsist] Verifica que el nombre de la mensaje no se encuentre registrado en el sistema con base en la regla de negocio \BRref{RN6}{Unicidad de nombres}. \hyperlink{CU9-1:TAF}{[Trayectoria F]}
...
\begin{enumerate}
	...
	\UCpaso[\UCsist] Muestra el campo del nuevo parámetro.
