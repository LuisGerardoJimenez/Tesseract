...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Ordena los mensajes alfabéticamente basándose en el nombre de los mismos.
	...
	\UCpaso[\UCactor] Gestiona los mensajes a través de los botones: \IUbutton{Registrar}, \editar, \eliminar y \raisebox{-1mm}{\includegraphics[height=11pt]{images/Iconos/consultar}}. \label{CU9-P4}
\end{UCtrayectoria}		
%--------------------------------------------------------------------------------------------------------------------------------
