	\begin{UseCase}{CU9.4}{Consultar Mensaje}{
			...
			Este caso de uso permite al colaborador (\hyperlink{jefe}{Líder} o \hyperlink{analista}{Analista}) consultar la información de un \hyperlink{MSGEntidad}{Mensaje} registrado en el \hyperlink{proyectoEntidad}{Proyecto} donde se está operando.
		
			Además del nombre del mensaje, el colaborador podrá consultar su descripción, redacción, así como sus parámetros.
	}
		...
		\UCitem{Salidas}{
			\begin{itemize}
				...
				\item \cdtRef{MSGEntidad:claveMSG}{Clave del Mensaje:} Lo obtiene el sistema.
