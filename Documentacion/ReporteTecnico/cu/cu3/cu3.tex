...
\UCExtenssionPoint{El actor requiere registrar una persona.}{Presionando el botón \IUbutton{Registrar} del paso \ref{CU3-P3} de la trayectoria principal o del paso \ref{CU3-A2} de la trayectoria alternativa A.}{\UCref{CU3.1}{Registrar Colaborador}}
\UCExtenssionPoint{El actor requiere modificar una persona.}{Presionando el icono \editar del paso \ref{CU3-P3} de la trayectoria principal.}{\UCref{CU3.2}{Modificar Colaborador}}
\UCExtenssionPoint{El actor requiere eliminar una persona.}{Presionando el icono \eliminar del paso \ref{CU3-P3} de la trayectoria principal.}{\UCref{CU3.3}{Eliminar Colaborador}}
