	\begin{UseCase}{CU2.3}{Eliminar proyecto de Administrador}{
		...
		\UCitem{Errores}{
		\cdtIdRef{MSG26}{No es posible eliminar proyecto}: Se muestra en la pantalla \IUref{IU2}{Gestionar proyectos de Adminstrador} cuando el proyecto tiene casos de uso asociados.
		}
