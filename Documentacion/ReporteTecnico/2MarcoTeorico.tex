...
\end{itemize}
\hyperlink{b16}{[16]}
Debido a sus similitudes, a veces Upper CASE y Middle CASE simplemente se conocen como Upper CASE. En general, Upper CASE es una herramienta para una vista de alto nivel del desarrollo de software, mientras que lower CASE se utiliza principalmente como herramienta en la fase de programación y prueba.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=.95\textwidth]{images/marcoteorico/mvc}
