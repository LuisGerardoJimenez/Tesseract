...
\section{Sprint 19: Revisión de casos de uso y generación del documento de análisis}
\subsection{Revisar Caso de uso, Terminar Caso de uso y Descargar documento}
\subsubsection {Análisis}

\begin{itemize}
	\item \textbf{Terminar Caso de Uso:} Cuando el colaborador considere que ha terminado por completo el registro de un Caso de Uso, puede concluir la edición del mismo en el sistema para que pueda ser revisado y finalmente liberado. Una vez que el
	colaborador termine el caso de uso ya no se encontrarán disponibles las acciones que involucren su edición ni la de sus elementos, tampoco podrá eliminarlo, únicamente estarán disponibles las acciones para consultarlo y revisarlo. 
	\item \textbf{Revisar Caso de Uso:} Una vez que el colaborador ha terminado un caso de uso, el líder podrá revisarlo para posteriormente liberarlo o solicitar correcciones. El líder examina y verifica que el contenido del caso de uso terminado sea correcto, de lo contrario registrará la observación de las correcciones necesarias en caso de que exista algún error por parte del colaborador que lo registró y editó.
	\item \textbf{Generar documento de análisis:} Se le permitirá al colaborador  descargar el documento de análisis. Este instrumento contiene cada uno de los elementos que se gestionan al interior de los módulos de cada proyecto como el glosario de terminos, descripción de las entidades, reglas de negocio, mensajes, actores, casos de uso (con sus trayectorias, precondiciones, postcondiciones y puntos de extensión) y pantallas, así como la informacióon propia del proyecto.
	El colaborador podrá elegir el formato de descarga del archivo (pdf o docx).
\end{itemize}
