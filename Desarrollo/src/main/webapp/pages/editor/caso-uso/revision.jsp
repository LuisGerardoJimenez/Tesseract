...
<![CDATA[
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/caso-uso/js/revision.js"></script>
]]>
</head>
<body>
	...
	<s:form autocomplete="off" theme="simple"
		action="%{pageContext.request.contextPath}/caso-uso!revisar">
							...
							<ol>
								<s:iterator value="ListPasosActual" var="paso">
									<li class="ui-widget"><s:if test="#paso.realizaActor">
											...
											<img
												src="${pageContext.request.contextPath}/resources/images/icons/uc.png" alt="casoUso"/>
