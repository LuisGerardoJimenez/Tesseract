...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/extensiones/js/token.js"></script>
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/extensiones/js/index-editNew.js"></script>
		...
		<div class="formulario">
			...
			<table class="seccion">
				...
				<tr>
					...
					<td><s:textarea name="model.causa" id="model.causa" cssErrorClass="input-error" maxlength="999" 
