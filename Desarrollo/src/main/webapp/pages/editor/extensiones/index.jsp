...
<![CDATA[
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/extensiones/js/index.js"></script>
]]>
</head>
				...
				<tr>
					...
					<td align="center">
						...
						<s:url var="urlModificar"
							value="%{#pageContext.request.contextPath}/extensiones/%{#ext.id}/edit" />
						<s:a href="%{urlModificar}">
							<img id="" class="button" title="Modificar Extension"
								src="${pageContext.request.contextPath}/resources/images/icons/Editar.svg" alt="Modificar Extension"/>
						</s:a>
						${blanks} 
						<!-- Eliminar extension --> 
						<s:a href="#" onclick="return mostrarMensajeEliminacion('%{#ext.id}');">
							<img id="" class="button" title="Eliminar Extension"
								src="${pageContext.request.contextPath}/resources/images/icons/Eliminar.svg" alt="Eliminar Extension"/>
						</s:a>
					</td>	
				</tr>
			</s:iterator>
