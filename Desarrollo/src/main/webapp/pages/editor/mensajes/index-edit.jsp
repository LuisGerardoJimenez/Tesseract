...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/mensajes/js/token.js"></script>
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/pages/editor/mensajes/js/index-edit.js"></script>		
]]>
			...
			<table class="seccion">
				...
				<tr>
						...
						<td><s:textarea rows="5" name="model.redaccion" cssClass="inputFormularioExtraGrande ui-widget" id="inputor" readonly="false"
								maxlength="500" cssErrorClass="input-error" oninput="verificarEsParametrizado();" onchange="verificarEsParametrizado();"/> 
								<s:fielderror
